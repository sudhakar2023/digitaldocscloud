								...
								<div class="col-lg-8 offset-lg-2 col-md-10 offset-md-1">
												<div class="land-title">
																<h2 class="wow fadeInUp" data-wow-duration="1s"
																				style="visibility: visible; animation-duration: 1s; animation-name: fadeInUp; color: #FFFFFF;">
																				Pricing</h2>
												</div>
								</div>
				</div>
																...
																<div class="col-md-3 col-sm-6">
																				<div class="pricingTable {{ $index == 1 ? 'blue' : '' }} {{ $index == 2 ? 'green' : '' }}">
																								<div class="pricingTable-header">
																												...
																												<div class="price-value">{{ $subscription->name }} <span
																								...
																								<div class="pricing-content">
																												<ul>
																																...
																																<li>User History
																																				<b>{{ $subscription->enabled_logged_history ? 'Enabled' : 'Disabled' }}</b></li>
																												</ul>
																								</div>
